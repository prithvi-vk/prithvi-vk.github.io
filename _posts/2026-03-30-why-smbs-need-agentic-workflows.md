...
1. **Understand context** — read an email, interpret a request, assess a situation
2. **Make decisions** — choose the right action based on what it finds
3. **Execute multi-step tasks** — chain together tools, APIs, and interfaces
4. **Handle edge cases** — adapt when things don't go as expected
...
[Let's figure that out together.](/contact)
